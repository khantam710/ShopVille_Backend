...
import { register, login, getUser, getUsers, updateUser, deleteUser, getUserStats } from '../controllers/user.controller.js'
import { verifyToken, verifyUser, verifyAdmin } from '../auth.js'
